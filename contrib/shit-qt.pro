...
RESOURCES += src/qt/shit.qrc src/qt/shit_locale.qrc

TRANSLATIONS += src/qt/locale/shit_bg.ts \
                src/qt/locale/shit_de.ts \
                src/qt/locale/shit_en.ts \
                src/qt/locale/shit_es.ts \
                src/qt/locale/shit_fi.ts \
                src/qt/locale/shit_fr.ts \
                src/qt/locale/shit_it.ts \
                src/qt/locale/shit_ja.ts \
                src/qt/locale/shit_pl.ts \
                src/qt/locale/shit_pt.ts \
                src/qt/locale/shit_ru.ts \
                src/qt/locale/shit_sk.ts \
                src/qt/locale/shit_sv.ts \
                src/qt/locale/shit_vi.ts \
                src/qt/locale/shit_zh_CN.ts \
                src/qt/locale/shit_zh_TW.ts
