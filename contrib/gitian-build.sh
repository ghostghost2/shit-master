...
VERSION=
commit=false
url=https://github.com/shitproject/shit
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the shit, gitian-builder, gitian.sigs, and shit-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/shitproject/shit
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit shit=${COMMIT} --url shit=${url} ../shit/contrib/gitian-descriptors/gitian-aarch64.yml
	    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../shit/contrib/gitian-descriptors/gitian-aarch64.yml
	    mv build/out/shit-*.tar.gz build/out/src/shit-*.tar.gz ../shit-binaries/${VERSION}
	fi
	popd || exit
