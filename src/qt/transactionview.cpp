 ...
 */
    ...
    typeWidget->addItem(tr("Received Shit from zShit"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zShit"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zShit));
