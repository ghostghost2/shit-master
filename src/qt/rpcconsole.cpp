                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzshitPathCustom = GetArg("-zshitbackuppath", "");
    ...
    if(!strzshitPathCustom.empty()) {
        ui->wallet_customzshitbackuppath->setText(QString::fromStdString(strzshitPathCustom));
        ui->wallet_customzshitbackuppath_label->setVisible(true);
        ui->wallet_customzshitbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzshitPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to The Shit RPC console.") + "<br>" + 
