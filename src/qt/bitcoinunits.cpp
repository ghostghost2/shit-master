...
QString BitcoinUnits::id(int unit)
{
    ...
    case SHIT:
        return QString("shit");
    case mSHIT:
        return QString("mshit");
    case uSHIT:
        return QString::fromUtf8("ushit");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case SHIT:
            return QString("tSHIT");
        case mSHIT:
            return QString("mtSHIT");
        case uSHIT:
            return QString::fromUtf8("μtSHIT");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SHIT:
            return QString("SHIT");
        case mSHIT:
            return QString("Milli-SHIT (1 / 1" THIN_SP_UTF8 "000)");
        case uSHIT:
            return QString("Micro-SHIT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SHIT:
            return QString("TestSHITs");
        case mSHIT:
            return QString("Milli-TestSHIT (1 / 1" THIN_SP_UTF8 "000)");
        case uSHIT:
            return QString("Micro-TestSHIT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
