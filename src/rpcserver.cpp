...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Shit features */
        {"shit", "masternode", &masternode, true, true, false},
        {"shit", "listmasternodes", &listmasternodes, true, true, false},
        {"shit", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"shit", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"shit", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"shit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"shit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"shit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"shit", "masternodedebug", &masternodedebug, true, true, false},
        {"shit", "startmasternode", &startmasternode, true, true, false},
        {"shit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"shit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"shit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"shit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"shit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"shit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"shit", "mnbudget", &mnbudget, true, true, false},
        {"shit", "preparebudget", &preparebudget, true, true, false},
        {"shit", "submitbudget", &submitbudget, true, true, false},
        {"shit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"shit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"shit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"shit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"shit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"shit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"shit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"shit", "checkbudgets", &checkbudgets, true, true, false},
        {"shit", "mnsync", &mnsync, true, true, false},
        {"shit", "spork", &spork, true, true, false},
        {"shit", "getpoolinfo", &getpoolinfo, true, true, false},
        {"shit", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzshitseed", &getzshitseed, false, false, true},
        {"zerocoin", "setzshitseed", &setzshitseed, false, false, true}
