...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("clubs.seed.shit.io", "clubs.seed.shit.io"));
        vSeeds.push_back(CDNSSeedData("hearts.seed.shit.io", "hearts.seed.shit.io"));
        vSeeds.push_back(CDNSSeedData("diamonds.seed.shit.io", "diamonds.seed.shit.io"));
        vSeeds.push_back(CDNSSeedData("spades.seed.shit.io", "spades.seed.shit.io"));
