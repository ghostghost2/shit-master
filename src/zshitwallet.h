...
#ifndef SHIT_ZSHITWALLET_H
#define SHIT_ZSHITWALLET_H
...
public:
    CzSHITWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSHIT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSHIT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //SHIT_ZSHITWALLET_H
