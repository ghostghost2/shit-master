...
#   c) node1 mines 32 blocks, so now node 0 has 60001shit, node 1 has 4250shit, node2 has none.
#   d) node0 sends 601 shit to node2, in two transactions (301 shit, then 300 shit).
