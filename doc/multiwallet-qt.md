...
In order to support loading of multiple wallets in shit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is shit.cpp.
...
Changes to shit.cpp
----------------------
shit.cpp is the entry point into shit-qt, and as such, will require some minor modifications to provide hooks for
