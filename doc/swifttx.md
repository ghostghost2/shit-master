...
This mechanism has been integrated into Bitcore-Node-SHit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/shitproject/insight-api-shit#web-socket-api](https://github.com/shitproject/insight-api-shit#web-socket-api) 
* API: [https://github.com/shitproject/insight-api-shit#swifttx-transactions](https://github.com/shitproject/insight-api-shit#swifttx-transactions) 
...
By default, the Shit Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Shit Core daemon:
